...
class Ui_MainWindow(QtWidgets.QMainWindow):
        ...
        "")
                ...
                self.timerTitle.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        "")
                ...
                self.TimerNumber.setMode(QtWidgets.QLCDNumber.Dec)
                self.TimerNumber.setSegmentStyle(QtWidgets.QLCDNumber.Filled)
                ...
                self.WordsTitle.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        "border: 1px solid black;")
                self.textContainer.setInputMethodHints(QtCore.Qt.ImhNone)
                self.textContainer.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        "color: rgb(0, 0, 0);\n"
        "border: 1px solid black;")
                self.ActiveWord.setAlignment(QtCore.Qt.AlignCenter)
                self.ActiveWord.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
                ...
                self.SecondTItle.setTextInteractionFlags(QtCore.Qt.NoTextInteraction)
        ...
        def write(self, e):
                ...
                if e.key() == QtCore.Qt.Key_Space or e.key() == QtCore.Qt.Key_Backspace:
        ...
        def eventFilter(self, source, event):
                if event.type() == QtCore.QEvent.FocusIn:
                        print(self.new_countdown.start)
